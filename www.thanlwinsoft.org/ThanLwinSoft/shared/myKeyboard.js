...
typeChar: function(charValue, pos)
{
  ...
  else
  {
    ...
    if (myK.currentSyllable[1] == '\u1004' && pos < 6)
    {
...
getCharOrder: function(theText, charIndex)
{
  ...
  switch (theChar)
  {
    ...
    case '\u103b':
    case '\u103c':
      order = myK.setOrderIfPrevious1039(theText, charIndex, 3);
      break;
    case '\u103d':
      order = myK.setOrderIfPrevious1039(theText, charIndex, 4);
      break;
    case '\u103e':
      order = myK.setOrderIfPrevious1039(theText, charIndex, 5);
      break;
    case '\u1031':
      order = 6;
      break;
