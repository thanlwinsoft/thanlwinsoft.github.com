<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html><head><title>A Guide to Using Myanmar Unicode: GTK/Pango</title>
...
<meta content="Myanmar Unicode GTK Gnome Pango" lang="en" name="keywords"/></head>
...
<li class="currentDoc"><span>Pango/GTK</span></li>
...
<p>There is also a Graphite Pango module which is available as source code from <a href="http://scripts.sil.org/svn-public/graphite/graphite/">Subversion</a>. Prebuilt debs are available for Ubuntu from <a href="http://packages.sil.org/">packages.sil.org</a>.
</p> 
<p>It should also be possible to use KDE with Myanmar Unicode since it also uses the Harfbuzz library for OpenType rendering. Unfortunately, the current KDE code doesn't work properly with existing Myanmar Unicode 5.1 fonts.</p>
</div>
<p class='right'><a href='../../MyanmarUnicode/Sorting/'>Sorting Myanmar&gt;&gt;</a></p>
<div class="footer">
