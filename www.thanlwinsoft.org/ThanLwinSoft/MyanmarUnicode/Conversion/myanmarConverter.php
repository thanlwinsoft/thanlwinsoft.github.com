<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html><head><title>A Guide to Using Myanmar Unicode: Convert from old Myanmar fonts to Unicode</title>
...
<meta content="Myanmar font converter" lang="en" name="keywords"/><script type='text/javascript' src='../../_shared/myWebDevelopment/common/tlsDebug.js'></script>
<script type='text/javascript' src='../../_shared/myWebDevelopment/converters/tlsMyanmarConverter.js'></script>
<script type='text/javascript' src='../../_shared/myWebDevelopment/converters/tlsMyanmarConverterData.js'></script>
</head>
<body onload="thanlwinLoaded();myUnicode.initParse('../../_shared/myWebDevelopment/');">
...
<ul class="contents"><li class="currentDoc"><span>Myanmar Font Converter</span></li>
<li class="contentsDoc"><a href="../../MyanmarUnicode/Conversion/TECkit.php" title="DocCharConverter &amp; TECkit">TECkit</a></li>
...
<h2>Convert from old Myanmar fonts to Unicode</h2>
<div>

<form action="">
<label for="initialEncoding">Convert from </label>
<select id="initialEncoding" name="initialEncoding" onchange="setFont(this.value, 'textToConvert');">
...
<label for="initialEncoding"> to </label>
...
<br />
<textarea id="textToConvert" title="Text to Convert" style="width: 400px;"></textarea>
<br />
<textarea id="convertedText" title="Converted text" style="width: 400px;" readonly="readonly"></textarea>
<!--
<br />
...
<p class='right'><a href='../../MyanmarUnicode/Conversion/TECkit.php'>TECkit&gt;&gt;</a></p>
<div class="footer">
