...
<li class="currentDoc"><span>Keyboard</span></li>
<li class="contentsDoc"><a href="../../MyanmarUnicode/WebDevelopers/myWebEgSvg.php" title="Using SVG to display Myanmar Unicode">SVG Font</a></li>
...
<form>
<textarea cols="60" rows="10" class="my" name="b" id="areaInput"></textarea>
</form>
...
document.addEventListener("load", function()
{
  if (myK && myK.lang != 'my')
	{
		myK.toggleLangKeyboard('my', 'areaInput');
	}
}, true);
</script>
<!--
...
<p class='right'><a href='../../MyanmarUnicode/WebDevelopers/myWebEgSvg.php'>SVG Font&gt;&gt;</a></p>
<div class="footer">
